...
async function destroy(req, res) {
  try {
    ...
    respuestas.success(req, res, "Periodo eliminado correctamente", 200);
  } catch (error) {
    respuestas.error(req, res, error, 500);
  }
}
...
async function insert(req, res) {
  try {
    ...
    respuestas.success(req, res, "Periodo creado correctamente", 200);
  } catch (error) {
    respuestas.error(req, res, error, 500);
  }
}
...
async function update(req, res) {
  try {
    ...
    respuestas.success(req, res, "Periodo actualizado correctamente", 200);
  } catch (error) {
    respuestas.error(req, res, error, 500);
  }
}
