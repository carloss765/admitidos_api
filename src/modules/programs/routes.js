...
async function destroy(req, res) {
  try {
    ...
    respuestas.success(req, res, "Programa eliminado correctamente", 200);
  } catch (error) {
    respuestas.error(req, res, error, 500);
  }
}
...
async function insert(req, res) {
  try {
    ...
    respuestas.success(req, res, "Programa creado correctamente", 200);
  } catch (error) {
    respuestas.error(req, res, error, 500);
  }
}
...
async function update(req, res) {
  try {
    ...
    respuestas.success(req, res, "Programa actualizado correctamente", 200);
  } catch (error) {
    respuestas.error(req, res, error, 500);
  }
}
